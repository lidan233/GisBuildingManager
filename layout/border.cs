...
namespace MapControlApplication7.layout
{
    ...
    /// </summary>
    [Guid("db08adb5-3cdf-4460-ae82-af74a5bcd3aa")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("MapControlApplication7.layout.border")]
    public sealed class border : BaseCommand
    {
        ...
        public border(IPageLayoutControl3 m_PageLayControl1)
        {
            //
