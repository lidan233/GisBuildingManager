...
namespace MapControlApplication7.layout
{
    ...
    /// </summary>
    [Guid("1309bfda-5581-4d2e-b765-0391628ade50")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("MapControlApplication7.layout.shadow")]
    public sealed class shadow : BaseCommand
    {
        ...
        public shadow(IPageLayoutControl3 m_PageLayControl1)
        {
            //
